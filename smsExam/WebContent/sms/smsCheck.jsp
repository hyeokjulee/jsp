<%@ page language="java" import="java.util.*, java.security.*, java.io.*, java.net.*, java.util.Base64.*"%>
<%!
	/**==============================================================
...
<%
	...
	if(action.equals("go")) {
	    ...
	    String sphone1 = base64Encode(nullcheck(request.getParameter("010"), "")); //발신자
	    String sphone2 = base64Encode(nullcheck(request.getParameter("2737"), ""));	//(가입자)
	    String sphone3 = base64Encode(nullcheck(request.getParameter("3944"), ""));	//폰번호
