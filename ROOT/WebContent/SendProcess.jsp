<%@ page import="java.io.*, java.util.*, smtp.*" language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%
// 폼값(이메일 내용) 저장
...
try {
    GoogleSMTP smtpServer = new GoogleSMTP();  // 메일 전송 클래스 생성
